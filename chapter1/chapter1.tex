...
Besides Dijkstra shortest path tracing, variants of, conceptually similar, fast marching algorithm \cite{sethian1999level} have been successfully adopted to the neuron reconstruction domain reporting the range of improvements related to tracing the discontinuous areas using gradient descent \cite{liu2016rivulet} \cite{van2007subvoxel,xiao2013app2,liu2016rivulet}.
...
\cite{schmitt2004new}
 \cite{wang2011broadly} have been used in neuron tracing. Ba  \cite{wang2011broadly}

Accurately merging the obtained traces into a tree reconstruction represents a significant challenge. Due to the complexity of the problem (many alternatives to examine) and the amount of computation needed to reach the solution, assembling  a tree structure is typically solved as the approximation. multiple tracts and merging their shared portions.
