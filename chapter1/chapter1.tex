...
%Minimum spanning tree (MST) are prominent method for the tree structure reconstruction and have been extensively used over the domain both for tracing and to merge together the obtained segments.
% for instance k-MST \cite{turetken2011automated}
...
%-------------------------------------------------------
\red{Global versus local processing trade-off is essential for the method success as the correct generalizations represent a true challenge.  
Algorithms rely on overcomplicated geometrical assumptions
The sheer number of computation recipes indicates. The processing is also scattered and distributed. Missing monolithic solution.}
