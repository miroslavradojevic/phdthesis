...
\begin{itemize}
	...
	\item \textbf{M.~Radojevi\'{c}}, E.~Meijering, ``Automated neuron reconstruction from 3D fluorescence microscopy images using sequential Monte Carlo estimation'', \emph{Neuroinformatics}, \emph{in press}, 2018%vol.~0, no.~0, pp.~0-0
