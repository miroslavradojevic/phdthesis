...
\begin{figure}
	\centering
	\begin{tabular}{c@{\hspace{0.02\columnwidth}}c@{\hspace{0.02\columnwidth}}c}
		\includegraphics[width=0.31\columnwidth]{fig9a} &% ./fig/compare/saria/p
		\includegraphics[width=0.31\columnwidth]{r_saria} &% ./fig/compare/saria/r
		\includegraphics[width=0.31\columnwidth]{f_saria} \\%[1ex]% ./fig/compare/saria/f
		\includegraphics[width=0.31\columnwidth]{sd_saria} &% ./fig/compare/saria/sd
		\includegraphics[width=0.31\columnwidth]{ssd_saria} &% ./fig/compare/saria/ssd
		\includegraphics[width=0.31\columnwidth]{pssd_saria} \\% ./fig/compare/saria/pssd
	\end{tabular}
