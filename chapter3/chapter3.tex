...
\begin{figure}
	...
	\begin{tabular}{c@{\hspace{0.02\columnwidth}}c@{\hspace{0.02\columnwidth}}c}
		...
		\includegraphics[width=0.31\columnwidth]{r_opf} &% compare/opf/r
		\includegraphics[width=0.31\columnwidth]{f_opf} \\%[1ex]% compare/opf/f
		\includegraphics[width=0.31\columnwidth]{sd_opf} &% compare/opf/sd
		\includegraphics[width=0.31\columnwidth]{ssd_opf} &% compare/opf/ssd
		\includegraphics[width=0.31\columnwidth]{pssd_opf} \\% compare/opf/pssd
	\end{tabular}
...
% add here S6 (fig10) and S7 (fig11)
