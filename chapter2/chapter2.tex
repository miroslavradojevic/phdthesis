...
The computed angular profile is further processed in order to extract several features (Fig.~\ref{fig4}) relevant for critical-point detection and characterization:
