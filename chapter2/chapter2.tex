...
\label{ch2:subsec:flrb-detection} % https://english.stackexchange.com/questions/242583/rephrase-to-the-best-of-my-knowledge
...
\begin{figure}
	\centering
	\begin{tabular}{c@{\hspace{1em}}c@{\hspace{1em}}}
		\includegraphics[width=0.4\columnwidth]{nmorpho_snr4_embedded} &
		\includegraphics[width=0.4\columnwidth]{nmorpho_snr_embedded}
	\end{tabular}
