...
% ************************************************************************
\begin{publish}
	Based upon: M. Radojevi\'{c}, E. Meijering, ``Automated neuron reconstruction from 3D fluorescence microscopy images using sequential Monte Carlo estimation'', \textit{Neuroinformatics}, \textit{in press}, 2018.% vol. 0, no. 0, pp.0-0
\end{publish}
...
\begin{figure}
	\centering
	\begin{tabular}{cc}
		\includegraphics[width=0.35\columnwidth]{fig2a_embedded} &
		\includegraphics[width=0.35\columnwidth]{fig2b_embedded} \\ %\hspace{2em} 
...
In the update step, the newly drawn samples are updated using the following likelihood function (Fig.~\ref{ch4_fig2}b):
\begin{equation}
...
\begin{figure}
	...
	\includegraphics[align=c,width=0.48\textwidth]{fig6a_embedded} &
	\includegraphics[align=c,width=0.48\textwidth]{fig6b_embedded} \\
	\\[0.01\columnwidth]
	\rotatebox[origin=c]{90}{COR = 1} &
	\includegraphics[align=c,width=0.48\textwidth]{fig6c_embedded} &
	\includegraphics[align=c,width=0.48\textwidth]{fig6d_embedded}
		\end{tabular}
	...
	& \hspace{2.5em}S = 2 & \hspace{2.5em}S = 3 \\[0.5em]
	\rotatebox[origin=c]{90}{COR = 0} &
	\includegraphics[align=c,width=0.48\textwidth]{fig7a_embedded} &
	\includegraphics[align=c,width=0.48\textwidth]{fig7b_embedded} \\
	\\[0.01\textwidth]
	\rotatebox[origin=c]{90}{COR = 1} &
	\includegraphics[align=c,width=0.48\textwidth]{fig7c_embedded} &
	\includegraphics[align=c,width=0.48\textwidth]{fig7d_embedded}
		\end{tabular}
		\caption{Examples are shown for COR = 0 (top) and 1 (bottom) in combination with S = 2 (left) and 3 (right).}
		\label{ch4_fig7}
	\end{subfigure}
...
\begin{figure}
	...
	\begin{tabular}{c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{}}
		...
		\includegraphics[align=c,width=0.23\textwidth]{fig8a_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig8b_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig8c_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig8d_embedded} \\
		\\[0.2ex]
		\rotatebox[origin=c]{90}{S = 3} &
		\includegraphics[align=c,width=0.23\textwidth]{fig8e_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig8f_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig8g_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig8h_embedded}
	\end{tabular}
...
\begin{figure}
	...
	\begin{tabular}{c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{}}
		& \hspace{2em}SNR = 2 & \hspace{2em}SNR = 4 & \hspace{2em}SNR = 5 & \hspace{2em}SNR = 10 \\[0.5ex]
		\rotatebox[origin=c]{90}{S = 2} &
		\includegraphics[align=c,width=0.23\textwidth]{fig9a_shift_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig9b_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig9c_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig9d_embedded} \\
		\\[0.2ex]
		\rotatebox[origin=c]{90}{S = 3} &
		\includegraphics[align=c,width=0.23\textwidth]{fig9e_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig9f_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig9g_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig9h_embedded}
	\end{tabular}
...
\begin{figure}
	...
	\begin{tabular}{c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{}}
		& \hspace{2em}SNR = 2 & \hspace{2em}SNR = 4 & \hspace{2em}SNR = 5 & \hspace{2em}SNR = 10 \\[0.5ex]
	    \rotatebox[origin=c]{90}{COR = 0}  &
		\includegraphics[align=c,width=0.23\textwidth]{fig10a_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig10b_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig10c_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig10d_embedded} \\
		\\[0.2ex]
		\rotatebox[origin=c]{90}{COR = 1}  &
		\includegraphics[align=c,width=0.23\textwidth]{fig10e_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig10f_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig10g_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig10h_embedded}
	\end{tabular}
...
\begin{figure}
	...
	\begin{tabular}{c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{\hspace{0.5em}}c@{}}
		& \hspace{2em}SNR = 2 & \hspace{2em}SNR = 4 & \hspace{2em}SNR = 5 & \hspace{2em}SNR = 10 \\[0.5ex]
		\rotatebox[origin=c]{90}{COR = 0} &
		\includegraphics[align=c,width=0.23\textwidth]{fig11a_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig11b_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig11c_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig11d_embedded} \\
		\\[0.2ex]
		\rotatebox[origin=c]{90}{COR = 1} &
		\includegraphics[align=c,width=0.23\textwidth]{fig11e_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig11f_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig11g_embedded} &
		\includegraphics[align=c,width=0.23\textwidth]{fig11h_embedded}
	\end{tabular}
...
\begin{figure}
	...
	\begin{tabular}{c@{\hspace{0.5em}}c@{\hspace{0.2em}}c@{\hspace{0.2em}}c@{\hspace{0.2em}}c@{\hspace{0.2em}}c@{\hspace{0.2em}}c@{\hspace{0.2em}}}
		...
		\includegraphics[align=c,width=0.135\textwidth]{fig12a1} &
		...
		\includegraphics[align=c,width=0.135\textwidth]{fig12b1} &
		...
		\includegraphics[align=c,width=0.135\textwidth]{fig12c1} &
		...
		\includegraphics[align=c,width=0.135\textwidth]{fig12d1} &
		...
		\includegraphics[align=c,width=0.135\textwidth]{fig12e1} &
...
\begin{figure}
	\centering
	\begin{tabular}{cc}
		\includegraphics[width=0.35\columnwidth]{fig15a_embedded} &
		\includegraphics[width=0.35\columnwidth]{fig15b_embedded} \\%[0.01\columnwidth]
		\includegraphics[width=0.35\columnwidth]{fig15c_embedded} &
		\includegraphics[width=0.35\columnwidth]{fig15d_embedded}
	\end{tabular}
...
\begin{figure}
	\centering
	\begin{tabular}{c@{}c@{}}
		\includegraphics[width=0.35\columnwidth]{fig16a_embedded} &
		\includegraphics[width=0.35\columnwidth]{fig16b_embedded} \\%[0.01\columnwidth]
		\includegraphics[width=0.35\columnwidth]{fig16c_embedded} &
		\includegraphics[width=0.35\columnwidth]{fig16d_embedded}
	\end{tabular}
