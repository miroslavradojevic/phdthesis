...
\begin{figure}
	\centering
	\begin{tabular}{cc}
		\includegraphics[width=0.35\columnwidth]{fig3a} &
		\includegraphics[width=0.35\columnwidth]{fig3b} \\
		(a) 3D  & (b)  2D
	\end{tabular}
...
\end{equation}
by applying mean-shifting \cite{cheng1995mean}, resulting in an updated node set $\bar{\mathcal{N}}$. Mean-shifting iteratively moves each node element to the local mean of the nodes in its vicinity. This reduces the variance of the estimates but preserves the linking of the nodes: $\bar{\mathcal{I}}=\mathcal{I}$. In practice, five iterations are sufficient to reach satisfactory radial trace alignment (Fig.~\ref{fig:merging}B). The kernel size used in the mean-shifting process is taken to be the initial radius of each node. In our implementation, prior to mean-shifting, we resample all traces with a step size of one voxel to get a more fine-grained result.
...
The final step of our method is the construction of a graph representing the complete neuronal arbor. This is facilitated by the bidirectional connectivity of the group nodes in $\hat{\mathcal{N}}$. However, similar to a real neuron, the final graph must be a tree, in which the nodes are unidirectionally linked (Figs.~\ref{fig:method}F and \ref{fig:merging}D), as also required by the SWC file format for storing digital neuron reconstructions \cite{stockley1993system, cannon1998line}. Starting from the soma node, or from the group node with the highest cross-correlation value if no soma was found in the image, the nodes in $\hat{\mathcal{N}}$ are iteratively traversed using a breadth-first search (BFS) algorithm. In this process it is possible to discard any isolated branches and single-node terminal branches (false positives).
...
\begin{figure}
	\centering\tiny
	\begin{tabular}{ccc}%{@{}c@{\hspace{0.02\columnwidth}}c@{\hspace{0.02\columnwidth}}c@{}}
		& \hspace{3.5em}S = 2 & \hspace{3.5em}S = 3 \\[0.02\columnwidth]
		\rotatebox{90}{\hspace{0.5em}COR = 0} &
		\includegraphics[align=c,width=0.35\columnwidth]{fig6a} &
		\includegraphics[align=c,width=0.35\columnwidth]{fig6b} \\
		\\[0.01\columnwidth]
		\rotatebox{90}{\hspace{0.5em}COR = 1} &
		\includegraphics[align=c,width=0.35\columnwidth]{fig6c} &
		\includegraphics[align=c,width=0.35\columnwidth]{fig6d}
	\end{tabular}
	...
	\label{fig6}%fig:f[snr]_synthetic
\end{figure}
...
\begin{figure}
	...
	\begin{tabular}{ccc}%{@{}c@{\hspace{0.02\columnwidth}}c@{\hspace{0.02\columnwidth}}c@{}}
		& \hspace{3.5em}S = 2 & \hspace{3.5em}S = 3 \\[0.02\columnwidth]
		\rotatebox{90}{\hspace{0.5em}COR = 0} &
		\includegraphics[align=c,width=0.35\columnwidth]{fig7a} &
		\includegraphics[align=c,width=0.35\columnwidth]{fig7b} \\
		\\[0.01\columnwidth]
		\rotatebox{90}{\hspace{0.5em}COR = 1} &
		\includegraphics[align=c,width=0.35\columnwidth]{fig7c} &
		\includegraphics[align=c,width=0.35\columnwidth]{fig7d}
	\end{tabular}
	...
	\label{fig7}%fig:ssd[snr]_synthetic
\end{figure}

\begin{figure}
	\centering\tiny
	\begin{tabular}{ccccc}%{@{}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{}}
	...
	\label{fig8}%fig:f[cor]_synthetic
\end{figure}

\begin{figure}%./fig/exp.syn/compare_cor/
	\centering\tiny
	\begin{tabular}{ccccc}%{@{}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{}}
		& \hspace{4em}SNR = 2 & \hspace{4em}SNR = 4 & \hspace{4em}SNR = 5 & \hspace{4em}SNR = 10 \\[0.01\textwidth]
	...
	\label{fig9}%fig:ssd[cor]_synthetic
\end{figure}

\begin{figure}%./fig/exp.syn/compare_S/
	\centering\tiny
	\begin{tabular}{ccccc}%{@{}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{}}
		& \hspace{4em}SNR = 2 & \hspace{4em}SNR = 4 & \hspace{4em}SNR = 5 & \hspace{4em}SNR = 10 \\[0.01\textwidth]
		\rotatebox{90}{\hspace{0.5em}COR = 0} &
		\includegraphics[align=c,width=0.238\textwidth]{_F(S,cor=0.0,snr=2)} &
		\includegraphics[align=c,width=0.238\textwidth]{_F(S,cor=0.0,snr=4)} &
		\includegraphics[align=c,width=0.238\textwidth]{_F(S,cor=0.0,snr=5)} &
		\includegraphics[align=c,width=0.238\textwidth]{_F(S,cor=0.0,snr=10)} \\
		\\[0.005\textwidth]
		\rotatebox{90}{\hspace{0.5em}COR = 1} &
		\includegraphics[align=c,width=0.238\textwidth]{_F(S,cor=1.0,snr=2)} &
		\includegraphics[align=c,width=0.238\textwidth]{_F(S,cor=1.0,snr=4)} &
		\includegraphics[align=c,width=0.238\textwidth]{_F(S,cor=1.0,snr=5)} &
		\includegraphics[align=c,width=0.238\textwidth]{_F(S,cor=1.0,snr=10)}
	\end{tabular}
	...
	\label{fig10}%fig:f[s]_synthetic
\end{figure}
...
\begin{figure}%./fig/exp.syn/compare_S/
	...
	\begin{tabular}{ccccc}%{@{}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{\hspace{0.01\textwidth}}c@{}}
		& \hspace{4em}SNR = 2 & \hspace{4em}SNR = 4 & \hspace{4em}SNR = 5 & \hspace{4em}SNR = 10 \\[0.01\textwidth]
		\rotatebox{90}{\hspace{0.5em}COR = 0} &
		\includegraphics[align=c,width=0.238\textwidth]{_SSD(S,cor=0.0,snr=2)} &
		\includegraphics[align=c,width=0.238\textwidth]{_SSD(S,cor=0.0,snr=4)} &
		\includegraphics[align=c,width=0.238\textwidth]{_SSD(S,cor=0.0,snr=5)} &
		\includegraphics[align=c,width=0.238\textwidth]{_SSD(S,cor=0.0,snr=10)} \\
		\\[0.005\textwidth]
		\rotatebox{90}{\hspace{0.5em}COR = 1} &
		\includegraphics[align=c,width=0.238\textwidth]{_SSD(S,cor=1.0,snr=2)} &
		\includegraphics[align=c,width=0.238\textwidth]{_SSD(S,cor=1.0,snr=4)} &
		\includegraphics[align=c,width=0.238\textwidth]{_SSD(S,cor=1.0,snr=5)} &
		\includegraphics[align=c,width=0.238\textwidth]{_SSD(S,cor=1.0,snr=10)}
	\end{tabular}
	...
	\label{fig11}%fig:ssd[s]_synthetic
\end{figure}

\begin{figure}%./fig/exp.syn.viz/150/pdf/
	\centering
	\begin{tabular}{ccccccc}%{@{}c@{\hspace{0.75em}}c@{\hspace{0.75em}}c@{\hspace{0.75em}}c@{\hspace{0.75em}}c@{\hspace{0.75em}}c@{\hspace{0.75em}}c@{}}
		SNR = 2 &
		\includegraphics[align=c,width=0.135\textwidth]{150_cor=0.0_snr=2__MAX}& 
		...
		\\[-1ex]
		SNR = 3 &
		\includegraphics[align=c,width=0.135\textwidth]{150_cor=0.0_snr=3__MAX} &
		...
		\\[-1ex]
		SNR = 4 &
		\includegraphics[align=c,width=0.135\textwidth]{150_cor=0.0_snr=4__MAX} &
		...
		\\[-1ex]
		SNR = 5 &
		\includegraphics[align=c,width=0.135\textwidth]{150_cor=0.0_snr=5__MAX} &
		...
		\\[-1ex]
		SNR = 10 &
		\includegraphics[align=c,width=0.135\textwidth]{150_cor=0.0_snr=10__MAX} &
...
\begin{figure}
	\begin{tabular}{@{}c@{\hspace{0.02\columnwidth}}c@{}}
		\includegraphics[width=0.49\columnwidth]{f_s=2_0} &
		\includegraphics[width=0.49\columnwidth]{ssd_s=2_0} \\[0.01\columnwidth]
		\includegraphics[width=0.49\columnwidth]{f_avg} &
		\includegraphics[width=0.49\columnwidth]{ssd_avg}
	\end{tabular}
