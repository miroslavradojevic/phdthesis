...
\begin{figure}
	\centering
	\begin{tabular}{c@{\hspace{0.5em}}p{0.15\textwidth}c@{}c@{}c@{}c@{}c@{}}
		\rotatebox[origin=c]{90}{SNR = 2}  & \multicolumn{6}{c}{\includegraphics[align=c,width=0.9\textwidth]{fig12a}} \\
		\\[-1ex]
		\rotatebox[origin=c]{90}{SNR = 3}  & \multicolumn{6}{c}{\includegraphics[align=c,width=0.9\textwidth]{fig12b}} \\
		\\[-1ex]
		\rotatebox[origin=c]{90}{SNR = 4}  & \multicolumn{6}{c}{\includegraphics[align=c,width=0.9\textwidth]{fig12c}} \\
		\\[-1ex]
		\rotatebox[origin=c]{90}{SNR = 5}  & \multicolumn{6}{c}{\includegraphics[align=c,width=0.9\textwidth]{fig12d}} \\
		\\[-1ex]
		\rotatebox[origin=c]{90}{SNR = 10} & \multicolumn{6}{c}{\includegraphics[align=c,width=0.9\textwidth]{fig12e}} \\
		\\[-1ex]
		                                   & \multicolumn{6}{c}{\includegraphics[align=c,width=0.9\textwidth]{fig12f}} \\
		                                   & \hspace{0.15\textwidth}  & APP2 & GPS & MST & PHD & PNR
%c@{\hspace{0.2em}}c@{\hspace{0.2em}}c@{\hspace{0.2em}}c@{\hspace{0.2em}}c@{\hspace{0.2em}}		
